...
const MANUAL_SECTIONS = [
  ...
  },
  {
    ...
    icon: UserCheck,
    content: "โครงการที่ส่งแล้วจะเดินทางผ่านสายงานอนุมัติโดยอัตโนมัติ เริ่มจาก 'อาจารย์ที่ปรึกษา' ไปจนถึง 'คณบดี' คุณสามารถติดตามสถานะและดูว่าโครงการอยู่ที่ใครได้ตลอดเวลาในหน้าโครงการ"
  },
  {
    id: "summary-027",
